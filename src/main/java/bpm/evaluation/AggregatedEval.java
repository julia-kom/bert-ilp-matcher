...
public class AggregatedEval {
    ...
    public void toCSV(File file) throws IOException {
        ...
        csvWriter.append("Aggregated (MACRO),").append(this.tp+",").append(this.fp+",").append(this.fn+",").append(this.precisionMacro+",").append(this.recallMacro+",").append(this.fscoreMacro+",").append(this.overallTimeAvg+",").append(this.lpTimeAvg+",").append(this.labelSimTimeAvg+",").append(this.bpTimeAvg+"\n");
        csvWriter.append("Aggregated (MICRO),").append(this.tp+",").append(this.fp+",").append(this.fn+",").append(this.precisionMicro+",").append(this.recallMicro+",").append(this.fscoreMicro+",").append(this.overallTimeAvg+",").append(this.lpTimeAvg+",").append(this.labelSimTimeAvg+",").append(this.bpTimeAvg+"\n");
        ...
        for(Eval e : evals){
                csvWriter.append(e.getName().replace(',',';').replace("\n"," ")+",")
                         ...
                         .append(e.getBenchmark().getBPTime()+"\n");
            }
