...
public class BPPlusTest {
    ...
    public void failedSAP(){
        ...
        //Behavior only test
        Pipeline p1 = new Pipeline.Builder().withILP(AbstractILP.ILP.CUSTOM_IDENTIFICATION).atSimilarityWeight(0.3).withILPTimeLimit(1).withProfile(AbstractProfile.Profile.BPP).Build();
        p1.run(f1,f2);
    }
