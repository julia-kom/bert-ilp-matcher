...
public class BPPlusTest {
    ...
    public void testBPPlusLoopTest(){
        ...
        Assert.assertSame(plus.getRelationForEntities(t3,t2), AbstractProfile.Relation.BPP_REVERSE_DIRECT_CAUSAL);
        Assert.assertSame(plus.getRelationForEntities(t3,t3), AbstractProfile.Relation.BPP_CONFLICT);
        Assert.assertSame(plus.getRelationForEntities(t3,t4), AbstractProfile.Relation.BPP_REVERSE_INDIRECT_CAUSAL);
        ...
        //Assert.assertSame(plus.getRelationForEntities(t4,t3), AbstractProfile.Relation.BPP_REVERSE_INDIRECT_CAUSAL); // ?
