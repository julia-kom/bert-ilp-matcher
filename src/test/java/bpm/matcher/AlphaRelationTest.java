...
public class AlphaRelationTest {
    ...
    public void AlphaRelationTauTest() {
        ...
        AlphaRelations alpha = new AlphaRelations(net1);
        Assert.assertSame(alpha.getRelationForEntities(t1,t2), AbstractProfile.Relation.NONE);
        Assert.assertSame(alpha.getRelationForEntities(t2,t3), AbstractProfile.Relation.NONE);
