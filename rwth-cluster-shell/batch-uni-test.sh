...
#parameters: $1 weight, $2 ilp, $3 Word Similarity
...
java -jar ./ilp-profile-matcher-1.0-SNAPSHOT-jar-with-dependencies.jar -batch -gold-standard-path $HOME/eval-data/goldstandard/uni -net-path $HOME/eval-data/pnml/uni -similarity-weight $1 -ilp $2 -pre-match -word-sim $3